...
const submit = handleSubmit(async values => {
    ...
    if (image.value) {
        const data = {
            ...propiedad, ubicacion: center.value, imagen: url.value,
        }
        await updateDoc(docRef, data)
    } else {
        const data = {
            ...propiedad, ubicacion: center.value,
        }
        await updateDoc(docRef, data)
    }
    ...
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-form class="mt-10">
            ...
            <div class="my-5">
                ...
                <img v-if="image" :src="image" class='w-50' alt="Propiedad">
                <img v-else :src="propiedad?.imagen" class='w-50' alt="Propiedad">
            </div>
