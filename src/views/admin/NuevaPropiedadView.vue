...
<template>
    ...
    <v-form class="mt-10">
        ...
        <v-file-input accept="image/jpeg" class="mb-5" label="Fotografia" prepend-icon="mdi-camera"
        ...
        <v-row>
            ...
            <v-col cols="12" md="4">
                <v-select label="Lugares Estacionamientos" class="mb-5" :items="items" v-model="estacionamiento.value.value"
        ...
        <v-checkbox class="mb-5" label="Alberca" v-model="alberca.value.value"
